    ...
    <div className="bg-white rounded-lg shadow p-6 flex flex-col">
      ...
      <div className="mt-auto p-3 bg-yellow-50 rounded-lg">
        <p className="text-xs text-yellow-800">
          ⚠️ Risk Score combines OI imbalance, extreme funding rates, market
          concentration, and volatility. Higher scores indicate increased
          probability of violent market moves.
        </p>
      </div>
    </div>
  );
